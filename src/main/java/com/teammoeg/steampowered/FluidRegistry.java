...
public class FluidRegistry {
    ...
    public static ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(steam, steamFlowing, FluidAttributes.builder(STILL_STEAM_TEXTURE, FLOWING_STEAM_TEXTURE).density(-10).viscosity(1)).block(BlockRegistry.steamBlock).slopeFindDistance(3).explosionResistance(100F);
}
